Alisinabit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/alisinabit/files/Alisinabit/alisinabit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Alisinabit
...
New/changed settings (command-line or alisinabit.conf file)
--------------------------------------------------------
