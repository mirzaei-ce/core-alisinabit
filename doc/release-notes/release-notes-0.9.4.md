Alisinabit Core version 0.9.4 is now available from:

  https://alisinabit.org/bin/0.9.4/
...
this update is incompatible with the Alisinabit system and could lead to consensus
forks.

Alisinabit Core released binaries from https://alisinabit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~alisinabit/+archive/ubuntu/alisinabit
- A third-party or self-compiled Alisinabit Core

upgrade to Alisinabit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
