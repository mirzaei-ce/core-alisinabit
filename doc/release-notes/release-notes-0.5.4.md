Alisinabit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/alisinabit/files/Alisinabit/alisinabit-0.5.4/
...
http://gitorious.org/alisinabit/alisinabitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Alisinabit-Qt notifications under Growl 1.3.
Increase required age of Alisinabit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAlisinabit properly when installing Alisinabit-Qt over it. (Windows)
