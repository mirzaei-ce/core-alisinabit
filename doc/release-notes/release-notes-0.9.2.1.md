Alisinabit Core version 0.9.2.1 is now available from:

  https://alisinabit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ABT to 0.01 ABT
...
- Fix "Start alisinabit on system login"
