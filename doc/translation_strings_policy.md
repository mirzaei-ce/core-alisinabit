...
This document provides guidelines for internationalization of the Alisinabit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `alisinabit_en.ts` remains unchanged.
