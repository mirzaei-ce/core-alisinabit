...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CAlisinabitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CAlisinabitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CAlisinabitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CAlisinabitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CAlisinabitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CAlisinabitAddress(arr[0].get_str()).Get() == demoAddress.Get());
