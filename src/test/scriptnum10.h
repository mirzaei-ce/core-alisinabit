...
#ifndef ALISINABIT_TEST_SCRIPTNUM10_H
#define ALISINABIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Alisinabit Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ALISINABIT_TEST_BIGNUM_H
