...
#ifndef ALISINABIT_QT_ALISINABITUNITS_H
#define ALISINABIT_QT_ALISINABITUNITS_H
...
/** Alisinabit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AlisinabitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AlisinabitUnits(QObject *parent);

    /** Alisinabit units.
      @note Source: https://en.alisinabit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ABT,
...
typedef AlisinabitUnits::Unit AlisinabitUnit;

#endif // ALISINABIT_QT_ALISINABITUNITS_H
