...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/alisinabit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Alisinabit Core"),
     ...
     * override -datadir in the alisinabit.conf file in the default data directory
     * (to be consistent with alisinabitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
