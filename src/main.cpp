...
#if defined(NDEBUG)
# error "Alisinabit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Alisinabit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s ABT additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("alisinabit-scriptch");
