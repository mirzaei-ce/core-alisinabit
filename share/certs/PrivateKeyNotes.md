...
unlocked to sign the Alisinabit-Qt.app bundle.
...
allowing somebody to distribute a Alisinabit-Qt.app or alisinabit-qt-setup.exe with a valid
...
that the alisinabit-qt.exe file inside the installer had not been tampered with.
